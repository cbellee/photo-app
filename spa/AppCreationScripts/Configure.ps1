...
param(
    ...
    [string] $TenantId = (Get-AzTenant | ? name -eq 'kainiindustries').Id
)
...
Function ConfigureApplications {
    ...
    Write-Host "Creating the AAD application (photo-react-spa)"
    # create the application 
    $spaAadApplication = New-MgApplication -DisplayName "photo-react-spa" `
